<?php 
	...
	if(isset($_POST['submit'])) {
		...
		$username = trim($_POST['username']);
                    //This shuffles the string      These are the possible characters                                      This is the string length
		$password = substr(str_shuffle(str_repeat("!@#$%&0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", 10)), 0, 10);
        //This code is from various sources, but I expanded on an example from here:
        //https://stackoverflow.com/questions/5438760/generate-random-5-characters-string
        
        //I don't know how secure this method is to create passwords
